...
function blossom_chic_customizer_register( $wp_customize ) {
    ...
    $theme_info = '<p>';
    $theme_info .= sprintf( __( 'Demo Link: %1$sClick here.%2$s', 'blossom-chic' ),  '<a href="' . esc_url( 'https://demo.blossomthemes.com/blossom-chic/' ) . '" target="_blank">', '</a>' );
    $theme_info .= '</p><p>';
    $theme_info .= sprintf( __( 'Documentation Link: %1$sClick here.%2$s', 'blossom-chic' ),  '<a href="' . esc_url( 'https://blossomthemes.com/blossom-chic-free-theme-documentation/' ) . '" target="_blank">', '</a>' );
    $theme_info .= '</p>';
...
function blossom_feminine_categories() {
    ...
    if ( 'post' === get_post_type() ) {
        ...
        $categories_list = get_the_category_list( esc_html__( ' ', 'blossom-chic' ) );
        if ( $categories_list ) {
...
function blossom_feminine_header(){ 
    ...
    <header id="masthead" class="site-header wow fadeIn header-layout-<?php echo esc_attr( $header_layout ); ?>" data-wow-delay="0.1s" itemscope itemtype="http://schema.org/WPHeader">
        ...
        <div class="header-b">
            <div class="container">
                <div id="primary-toggle-button"><i class="fa fa-bars"></i><?php esc_html_e( 'Navigation', 'blossom-chic' ); ?></div>
    ...
    <div class="site-info">
        <div class="container">
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/themes/blossom-chic-free-wordpress-theme' ) .'" rel="author" target="_blank">' . esc_html__( ' Blossom Chic', 'blossom-chic' ) . '</a>' . esc_html__( ' by Blossom Themes.', 'blossom-chic' );
